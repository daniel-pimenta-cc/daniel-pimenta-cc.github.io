...
import 'package:portfolio_daniel/presentation/widgets/bottom_draggable_scrollable_sheet.dart';
...
class _AboutPageMobileState extends State<AboutPageMobile>
  ...
  Widget _fadeInContent() {
    ...
    return AnimatedBuilder(
      ...
      child: Text(
        S.ABOUT_DEV_TEXT,
        style: theme.textTheme.bodyLarge!.copyWith(color: AppColors.bodyMedium),
      ),
