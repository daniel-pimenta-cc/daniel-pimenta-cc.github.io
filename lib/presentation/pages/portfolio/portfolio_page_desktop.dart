...
import 'package:portfolio_daniel/presentation/widgets/customer_scroller.dart';
            ...
            onTap: () {
              _navigateToProjectDetail(
                projectDetails: ProjectDetails(
                  ...
                  python: portfolioData[i].python,
                  database: portfolioData[i].database,
                  flutter: portfolioData[i].flutter,
                  docker: portfolioData[i].docker,
                  react: portfolioData[i].react,
                  css: portfolioData[i].css,
                  html: portfolioData[i].html,
                  javascript: portfolioData[i].javascript,
                  bootstrap: portfolioData[i].bootstrap,
                  php: portfolioData[i].php,
                  java: portfolioData[i].java,
                  wordpress: portfolioData[i].wordpress,
