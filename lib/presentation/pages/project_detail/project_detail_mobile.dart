...
import 'package:portfolio_daniel/presentation/widgets/project_cover.dart';
            ...
            ? FadeTransition(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    SpaceH8(),
                    if (widget.projectDetails!.technologyUsed != null &&
                        widget.projectDetails!.technologyUsed!.isNotEmpty) ...[
                      Text(
